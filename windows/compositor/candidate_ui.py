...
class CandidateDialog(QDialog):
    def __init__(self,editor,job):
        ...
        self.version=QComboBox(); self.version.addItems(['With candidate','Current artwork']); controls.addWidget(self.version)
        ...
        self.zoom=QComboBox()
        for scale in (1,2,3,4,6,8,12,16): self.zoom.addItem(f'{scale*100}%',scale)
        self.zoom.setCurrentIndex(2 if self.document.pixel_art else 0); controls.addWidget(self.zoom); controls.addStretch()
